...
(
    ...
    PRIMARY KEY (`flow_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COMMENT='本地工作流表';
...
(
    ...
    `branch_pid`       int(11) NOT NULL DEFAULT '0' COMMENT '如果产生分支为分支顶端ID',
    `process_desc`     varchar(255) NOT NULL DEFAULT '' COMMENT '步骤描述',
    `process_type`     int(11) NOT NULL DEFAULT '0' COMMENT '步骤类型  0为开始 1为步骤 2为结束',
...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COMMENT='本地工作流步骤表';
...
(
    ...
    PRIMARY KEY (`run_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='工作流执行状态表';
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COMMENT='工作流执行日志表';
...
(
    ...
    `status`           tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态 0为未处理，1为处理中 ,2为已结束,-1已打回',
    `is_sign`          varchar(50) NOT NULL DEFAULT '' COMMENT '已会签过ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COMMENT='工作流执行步骤表';
